<template>
  <router-link
    ...
    :class="
      active
        ? 'bg-emerald-400/[0.11] text-emerald-200 shadow-[inset_0_0_0_1px_rgba(110,231,183,.20),0_0_24px_rgba(16,185,129,.08)]'
        : 'text-slate-400 hover:bg-white/[0.055] hover:text-slate-100'
    "
  >
    <span
      v-if="active"
      class="absolute -left-4 h-7 w-[3px] rounded-r-full bg-emerald-300 shadow-[0_0_14px_rgba(110,231,183,.75)]"
    ></span>
    <span
      class="grid h-8 w-8 place-items-center rounded-lg transition-all"
      :class="
        active
          ? 'bg-emerald-400/[0.14] text-emerald-200 ring-1 ring-emerald-300/20'
