						...
						<div class="form-group">
							...
							<div class="input-wrapper">
								...
								<button type="button" class="toggle-password" @click="showPassword = !showPassword" aria-label="Toggle password visibility">
									<svg v-if="showPassword" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="18" height="18">
										<path stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88L8.62 8.62m4.52 4.52l1.26 1.26M18.825 18.825L3 3" />
									</svg>
									<svg v-else xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="18" height="18">
					...
					<div class="social-buttons">
						<button class="social-btn" @click="handleSocial('Google')">
							<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
								<path fill="#EA4335" d="M12 5.04c1.66 0 3.2.57 4.38 1.69l3.27-3.27C17.67 1.54 14.98 1 12 1 7.35 1 3.37 3.65 1.42 7.51l3.79 2.94C6.12 7.23 8.84 5.04 12 5.04z" />
								...
								<path fill="#FBBC05" d="M5.21 14.81c-.24-.72-.38-1.49-.38-2.31s.14-1.59.38-2.31L1.42 7.25C.52 9.07 0 11.08 0 13s.52 3.93 1.42 5.75l3.79-2.94z" />
								<path fill="#34A853" d="M12 23c3.24 0 5.97-1.07 7.96-2.91l-3.76-2.91c-1.1.74-2.52 1.18-4.2 1.18-3.16 0-5.88-2.19-6.79-5.41L1.42 18.8C3.37 22.35 7.35 23 12 23z" />
							</svg>
							Google
						</button>
...
const handleLogin = () => {
	alert(`Logging in with: ${loginForm.email}`)
}
