    ...
    >
      ...
      >
        ...
        >
          ...
          on
          <span class="text-slate-800">
            {{ formatDate(bookingToRelease.bookingDate) }}
          </span>.
        </p>
...
function sortNewestFirst(a, b) {
  const first =
    bookingStartDateTime(a)

  const second =
    bookingStartDateTime(b)
